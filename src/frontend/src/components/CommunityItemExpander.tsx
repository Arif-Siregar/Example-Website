              ...
              <ul className="list-disc">
                {collectionPoints.map((cPoint: Method) => {
                  ...
                  if (cPoint.note && !cPoint.note.includes("http")) {
                    return (
                      <li className="ml-8 whitespace-normal text-[3.2vw] sm:text-[2.5vw] md:text-[2vw] lg:text-[1.5vw] xl:text-[1.3vw]" key={cPoint.note}>
                        <p>
                          <b>Note: </b>
                          {cPoint.note}
                        </p>
            ...
            <div className="mt-1 space-y-4 max-h-40 overflow-y-auto rule-scroll">
              {dropOffPoints.map((dpoint) => (
                ...
                <div key={JSON.stringify(dpoint)} className="ml-2 mt-1">
                  <div className="flex flex-row font-semibold items-center text-[3.4vw] sm:text-[2.7vw] md:text-[2vw] lg:text-[1.5vw] xl:text-[1.3vw]">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      className="w-[6vw] sm:w-[4.5vw] md:w-[3.7vw] lg:w-[3.2vw] xl:w-[2.5vw] mr-4 flex-shrink-0"
                    >
